...
<html lang="en">
    <head>
        ...
        <link href="<?php echo SCRIPT_ROOT.'/libs/bootstrap-colorpicker/bootstrap-colorpicker.min.css'; ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SCRIPT_ROOT.'/libs/clockpicker/bootstrap-clockpicker.min.css'; ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SCRIPT_ROOT.'/libs/bootstrap-datepicker/bootstrap-datepicker.min.css'; ?>" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo SCRIPT_ROOT.'/libs/bootstrap-touchspin/jquery.bootstrap-touchspin.css'; ?>" rel="stylesheet" type="text/css" />
          ...
          <!-- third party css -->
        <link href="<?php echo SCRIPT_ROOT.'/libs/datatables/dataTables.bootstrap4.css'; ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SCRIPT_ROOT.'/libs/datatables/responsive.bootstrap4.css'; ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SCRIPT_ROOT.'/libs/datatables/buttons.bootstrap4.css'; ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo SCRIPT_ROOT.'/libs/datatables/select.bootstrap4.css'; ?>" rel="stylesheet" type="text/css" />
